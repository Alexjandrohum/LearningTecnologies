...
import com.example.reciclerviewfragment.RestauranteFragment.OnListFragmentInteractionListener;
...
public class MyRestauranteRecyclerViewAdapter extends RecyclerView.Adapter<MyRestauranteRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        //Rescatamos  los datos del elemento que ocupa la posición
        ...
        Picasso.get()
                ...
                .resize(400,150)
                .centerCrop()
                .into(holder.imageViewPhotoRestaurate);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public final ImageView imageViewPhotoRestaurate;
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
            textViewNombreRestaurante = (TextView) view.findViewById(R.id.textViewNombre);
            textViewDireccionRestaurante = (TextView) view.findViewById(R.id.textViewDireccion);
            imageViewPhotoRestaurate = view.findViewById(R.id.imageViewPhoto);
