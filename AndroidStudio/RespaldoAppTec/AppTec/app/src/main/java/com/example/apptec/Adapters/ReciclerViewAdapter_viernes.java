...
public class ReciclerViewAdapter_viernes extends RecyclerView.Adapter<ReciclerViewAdapter_viernes.MyViewHolder> {

    Context mContext;
    List<ObjetosViernes> mData;

    public ReciclerViewAdapter_viernes(Context mContext, List<ObjetosViernes> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v;
        v = LayoutInflater.from(mContext).inflate(R.layout.item_viernes,viewGroup,false);
