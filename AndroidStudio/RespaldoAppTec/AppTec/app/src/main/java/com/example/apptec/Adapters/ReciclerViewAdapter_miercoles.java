...
public class ReciclerViewAdapter_miercoles extends RecyclerView.Adapter<ReciclerViewAdapter_miercoles.MyViewHolder> {

    Context mContext;
    List<ObjetosMiercoles> mData;

    public ReciclerViewAdapter_miercoles(Context mContext, List<ObjetosMiercoles> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v;
        v = LayoutInflater.from(mContext).inflate(R.layout.item_miercoles,viewGroup,false);
