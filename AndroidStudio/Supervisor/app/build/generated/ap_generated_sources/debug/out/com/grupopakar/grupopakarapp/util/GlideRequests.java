...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.grupopakar.grupopakarapp.util.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.grupopakar.grupopakarapp.util.GlideOptions().apply(toSet));
    }
  }
}
