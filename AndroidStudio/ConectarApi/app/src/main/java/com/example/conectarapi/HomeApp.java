...
public class HomeApp extends AppCompatActivity
    ...
    public static int mat, nombre;
    public static String nombreee, apppp, apmmm, grupo, grado, carrera;
    ...
    private void obtenerRecursoPerfil(){
        ...
        callPerfil.enqueue(new Callback<List<ModeloPerfil>>() {
            ...
            public void onResponse(Call<List<ModeloPerfil>> call, Response<List<ModeloPerfil>> response) {
                ...
                //Log.d("mensajito","matricula del alumno ######## "+mat);
                // Log.d("mensajito","Nombre del alumno ######## "+nombre);


                PruebaFragment perfilFragment = new PruebaFragment();
               ...
               perfilFragment.cachando(dat1,dat2,dat3,dat4,dat5,dat6,dat7);
