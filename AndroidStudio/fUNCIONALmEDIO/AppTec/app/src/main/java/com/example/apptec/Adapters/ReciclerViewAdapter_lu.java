...
public class ReciclerViewAdapter_lu extends RecyclerView.Adapter<ReciclerViewAdapter_lu.MyViewHolder> {

    Context mContext;
    List<ObjetosLu> mData;

    public ReciclerViewAdapter_lu(Context mContext, List<ObjetosLu> mData) {
