...
public class ReciclerViewAdapter_lunes extends RecyclerView.Adapter<ReciclerViewAdapter_lunes.MyViewHolder> {

    Context mContext;
    List<ObjetosLunes> mData;

    public ReciclerViewAdapter_lunes(Context mContext, List<ObjetosLunes> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v;
        v = LayoutInflater.from(mContext).inflate(R.layout.item_lunes,viewGroup,false);
