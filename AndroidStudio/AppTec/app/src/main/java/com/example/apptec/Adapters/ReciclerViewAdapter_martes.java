...
public class ReciclerViewAdapter_martes extends RecyclerView.Adapter<ReciclerViewAdapter_martes.MyViewHolder> {

    Context mContext;
    List<ObjetosMartes> mData;

    public ReciclerViewAdapter_martes(Context mContext, List<ObjetosMartes> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v;
        v = LayoutInflater.from(mContext).inflate(R.layout.item_martes,viewGroup,false);
