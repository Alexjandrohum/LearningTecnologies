...
public class ReciclerViewAdapter_sabado extends RecyclerView.Adapter<ReciclerViewAdapter_sabado.MyViewHolder> {

    Context mContext;
    List<ObjetosSabado> mData;

    public ReciclerViewAdapter_sabado(Context mContext, List<ObjetosSabado> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v;
        v = LayoutInflater.from(mContext).inflate(R.layout.item_sabado,viewGroup,false);
